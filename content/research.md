...
The thesis will focus on **attacks and defenses for Byzantine-resilient aggregation in federated learning**: studying how realistic federated attacks degrade robust aggregation rules, and how to design and harden aggregations against them. The work builds on the experimental rigor of the **[Krum](/projects/krum)** library.
