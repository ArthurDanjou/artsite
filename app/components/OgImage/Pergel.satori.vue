...
<template>
  <div class="w-full h-full flex flex-col justify-center relative overflow-hidden bg-neutral-50 dark:bg-neutral-900">
    ...
    <div class="max-w-250 pl-6 lg:pl-20">
      <p
        v-if="headline"
        class="uppercase text-[22px] text-amber-400 mb-3 font-bold tracking-wider"
      >
        {{ headline }}
      </p>
      ...
      <p
        v-if="description"
        class="text-[30px] text-neutral-600 dark:text-neutral-400 leading-[1.4]"
      >
        {{ description }}
      </p>
    </div>
