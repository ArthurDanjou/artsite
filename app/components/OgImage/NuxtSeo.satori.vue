...
<template>
  ...
  >
    ...
    <div class="w-full flex-col justify-center relative items-center text-center gap-5 lg:gap-8">
      ...
      <!-- Title -->
      <h1
        class="w-full justify-center text-center text-[48px] lg:text-[80px] font-bold m-0 leading-tight max-w-175 lg:max-w-250"
      ...
      <p
        v-if="description"
        class="text-[24px] lg:text-[32px] opacity-70 max-w-162.5 lg:max-w-225 leading-relaxed"
